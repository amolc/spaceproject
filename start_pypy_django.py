...
def check_databases():
    ...
    result = subprocess.run(["./pyvenv/bin/pypy3", "check_and_setup.py"])  # existing script handles DB checks
...
def run_migrations():
    ...
    result = subprocess.run(["./pyvenv/bin/pypy3", "manage.py", "migrate"]) 
    if result.returncode != 0:
...
def main():
    ...
    try:
        ...
        django_proc = subprocess.Popen(
            ["./pyvenv/bin/pypy3", "manage.py", "runserver", "127.0.0.1:8000"],
